...
(function() {
  ...
  this.Stripe = function() {
    ...
    return k(b, a), b.tokenName = "bank_account", b.whitelistedAttrs = ["country", "currency", "routing_number", "account_number", "name", "account_holder_type"], b.createToken = function(a, c, d) {
  ...
  this.Stripe.stripejs_ua = "stripe.js/699b119", "undefined" != typeof module && null !== module && (module.exports = this.Stripe), "function" == typeof define && define("stripe", [], function(a) {
    return function() {
      return a.Stripe
    }
  }(this))
  ...
  function() {
    ...
    this.Stripe.isDoubleLoaded || (this.Stripe.utils = function() {
      ...
      return c = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, b.trim = function(a) {
        ...
        for (null == c && (c = []),
          b.jquery && (b = b[0]), f = b.getElementsByTagName("input"), h = b.getElementsByTagName("select"), i = {}, j = 0, l = f.length; l > j; j++) e = f[j], d = this.underscore(e.getAttribute("data-stripe")), a.call(c, d) < 0 || (i[d] = e.value);
